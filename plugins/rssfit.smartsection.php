...
class RssfitSmartsection
{
    ...
    public function &grabEntries(&$obj)
    {
        ...
        $smartsectionHelper      = Xmf\Module\Helper::getHelper('smartsection');
        $smartsectionItemHandler = $smartsectionHelper->getHandler('item');
        $items                = $smartsectionItemHandler->getAllPublished($this->grab, 0);
