    ...
    public function &grabEntries(&$obj)
    {
        ...
        while ($row = $xoopsDB->fetchArray($result)) {
            if ((isset($perms[$row['cid']]) && true === $perms[$row['cid']])
                || $permHandler->checkRight('WFDownCatPerm', $row['cid'], is_object($GLOBALS['xoopsUser']) ? $GLOBALS['member_handler']->getGroupsByUser($GLOBALS['xoopsUser']->getVar('uid')) : XOOPS_GROUP_ANONYMOUS, $this->module->getVar('mid'))) {
                $perms[$row['cid']]     = true;
