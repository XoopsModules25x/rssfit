...
//about
$modversion['release_date']        = '2014/03/03';
...
$modversion['config'][3]['options'] = [_MI_ENTRIES_SORT_DATE =>'d', _MI_ENTRIES_SORT_CAT =>'c'];
...
$modversion['config'][8]['options'] = [_MI_OUTOUT_MIME_XML =>1, _MI_OUTOUT_MIME_HTML =>2, _MI_OUTOUT_MIME_PHP =>3];
